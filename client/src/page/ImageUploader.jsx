...
const Form = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      navigate("/result", {
        state: {
          gem_prediction: response.data.gem_prediction,
          shape_prediction: response.data.shape_prediction,
  ...
  return (
    <>
      ...
      <div className="bg-gray-100 min-h-screen">
        <div
          className="bg-cover bg-center sm:m-auto"
        ...
        >
          ...
          >
            <div className="mb-4">
              ...
              <p>
                Provide us your email address, if you want to receive your gem
                analysis report to your email
              </p>
              <input
                type="email"
                id="email"
